...
extensionsGallery='setpath(["extensionsGallery"]; {"serviceUrl": "https://marketplace.visualstudio.com/vscode/gallery", "itemUrl": "https://marketplace.visualstudio.com/items"})'
linkProtectionTrustedDomains='setpath(["linkProtectionTrustedDomains"]; ["https://marketplace.visualstudio.com"])'
